...
\author{Tobias Mack \& Daniel Müssig \& Robert Zoeke}
\title{TITEL}
...
%Beginn mit Motivation, was war die Idee, wozu braucht man sowas, was soll ungefähr geleistet werden
\begin{frame}
\frametitle{Motivation}
\begin{itemize}
\item Vorgegebenes Projektziel: Monitoringsystem
\item Entscheidung für Positionsdaten %warum?
\item Dank immer kleiner werdender Technik sowohl für Personen, als auch für beliebige Geräte denkbar
\item Simples Anzeigen auf einer Karte wäre ein unrealistischer Use Case
...
\begin{figure}
\begin{itemize}
\item Erlaubt live Überwachung mehrerer Dronen mittels GPS
...
\item Datenstruktur:
\begin{itemize}
\item userlist.xml für:
\begin{itemize}
\item Nutzerdaten (Name, Passwort)
\item Clientgeräte die für die Nutzer registriert sind
\item Zonen die für die Gerät registriert sind
\end{itemize}
\item XML-Dateien für jedes einzelne Gerät zur Speicherung der Positionsdaten
\end{itemize}
\end{itemize}
\end{frame}
...
\item eXist
	...
	\item Scheduler zum Aufräumen der DB
	\item URL Rewriting
	\end{itemize}
\end{itemize}
\end{frame}
...
\item Probleme:
\begin{itemize}
\item DELETE und PUT werden von Exist direkt ausgeführt
\item führt zum löschen bzw. überschreiben der aufgerufenen
\item Lösung: Verwendung von POST
\end{itemize}
\end{itemize}
\end{frame}
...
%was wird geleistet, was nicht? was wären die allerwichtigsten features/funktionen?
\section{Fazit}
\begin{frame}
\frametitle{Fazit}
\begin{itemize}
\item Grundfunktionalität implementiert
\item Wichtigster nächster Implementierungsschritt: Sicherheit
	\begin{itemize}
	\item Verschlüsselte Übertragung
	\item %was könnte man noch machen?
	\end{itemize}
